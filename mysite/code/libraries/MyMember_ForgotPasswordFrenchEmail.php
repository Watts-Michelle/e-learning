...
class MyMember_ForgotPasswordFrenchEmail extends Member_ForgotPasswordEmail
{
	...
	public function getContent()
	{
		...
		return str_replace(array_keys($search), array_values($search), $this->settings->FrenchForgottenPasswordBody);
	}
	...
	public function __construct() {
		...
		$this->subject = $this->settings->FrenchForgottenPasswordSubject;
	}
